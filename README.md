...
Welcome to **LuminaVault** — your personal knowledge guardian.
...
| Logo | Name | Description | Best For |
|------|------|-------------|----------|
| 1 | **Primary Brand Mark** | Full "LuminaVault" text + integrated glowing "L" symbol | Most official uses |
| 2 | **Symbolic Icon-Only** | Pure icon: glowing cyan scroll + golden wings + neural vault lock | Small spaces & icons |
